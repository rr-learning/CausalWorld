    ...
    def __init__(self, **kwargs):
        super().__init__(task_name="reaching",
                         ...
                         kwargs.get("dense_reward_weights",
                                    np.array([100000, 0, 0, 0])))

        self._task_robot_observation_keys = ["time_left_for_task",
                                             "joint_positions",
                                             "joint_velocities",
                                             "end_effector_positions"]
        self._task_params['default_goal_60'] = kwargs.get("default_goal_60", np.array([0, 0, 0.10]))
        self._task_params['default_goal_120'] = kwargs.get("default_goal_120", np.array([0, 0, 0.13]))
        self._task_params['default_goal_300'] = kwargs.get("default_goal_300", np.array([0, 0, 0.16]))
        self._task_params["joint_positions"] = kwargs.get("joint_positions", None)
